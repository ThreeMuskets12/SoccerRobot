...
float velocity_motor_0; //motor 0's target velocity
float velocity_motor_1;	//motor 1's target velocity
float velocity_motor_2; //motor 2's target velocity
float velocity_motor_3; //motor 3's target velocity
float velocity_motor_dribbler; //dribbler motor's target velocity
