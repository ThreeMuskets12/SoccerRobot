...
void EXTERNAL_IRQ_1_init(void)
{
	...
	gpio_set_pin_direction(PD1, GPIO_DIRECTION_IN);

	gpio_set_pin_pull_mode(PD1,
	...
	gpio_set_pin_function(PD1, GPIO_PIN_FUNCTION_OFF);
}
...
void system_init(void)
{
	...
	gpio_set_pin_level(Motor_Reset,
	                   // <y> Initial level
	                   // <id> pad_initial_level
	                   // <false"> Low
	                   // <true"> High
	...
	// Set pin direction to output
	gpio_set_pin_direction(Motor_Reset, GPIO_DIRECTION_OUT);

	gpio_set_pin_function(Motor_Reset, GPIO_PIN_FUNCTION_OFF);
